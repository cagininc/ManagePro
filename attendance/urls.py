...
from .views import check_office_status,check_in, check_out,user_attendance_list,check_status,user_attendance_weekly,server_side_attendance
...
urlpatterns = [
    ...
    path('status/',check_office_status,name='check_office_status'),# Ofiste bulunma durumu kontrol GET
